...
client = clickhouse_connect.get_client(
    host=CLICKHOUSE_HOSTNAME, port=CLICKHOUSE_PORT, username=CLICKHOUSE_USER, password=CLICKHOUSE_PASSWORD)

client.command("CREATE DATABASE IF NOT EXISTS ecommerce ENGINE = Memory COMMENT 'The ecommerce database';")

client.command("USE ecommerce")
